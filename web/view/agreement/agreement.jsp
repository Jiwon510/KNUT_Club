...
<head>
    ...
    <title>약관동의</title>
    <link rel="stylesheet" href="/view/agreement/agreement.css">
...
<header>
    <a href="main.jsp"><img id="logo" src="/view/agreement/images/header_logo.jpg"></a>
    <h1>KNUT-CLUB</h1>
</header>

<section>
    <form action="/agreement" id="agreementform" method="get">
        ...
        <ul class="footer clearfix">
            <li>
                <button class="fcBtn1" type="button" onclick="location.href='/view/index/index.jsp'">비동의</button>
            </li>
            <li>
                <button class="fcBtn2" type="submit" onclick="location.href='/view/agreement/agreement'">동의</button>
            </li>
        </ul>
    </form>
</section>
